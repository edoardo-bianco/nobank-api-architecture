# nobank-api-architecture-template-app Project
...
You can then execute your native executable with: `./target/nobank-api-architecture-template-app-1.0.0-SNAPSHOT-runner`
